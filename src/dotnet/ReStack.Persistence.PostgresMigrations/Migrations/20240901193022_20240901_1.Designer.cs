...
namespace ReStack.Persistence.PostgresMigrations.Migrations
{
    ...
    [Migration("20240901193022_20240901_1")]
    partial class _20240901_1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ReStack.Domain.Entities.StackTag", b =>
                {
                    b.Property<int>("StackId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ReStack.Domain.Entities.Tag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ReStack.Domain.Entities.StackTag", b =>
                {
                    ...
                    b.HasOne("ReStack.Domain.Entities.Tag", "Tag")
                        .WithMany("Stacks")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
